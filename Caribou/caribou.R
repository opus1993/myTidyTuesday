...
# Credit George Karamanis https://github.com/gkaramanis/tidytuesday/tree/master/2020-week26
...
ggplot(movement) +
  ...
  ggsave(here::here("Caribou", paste0("caribou-", format(Sys.time(), "%Y%m%d_%H%M%S"), ".png")), dpi = 320, height = 9, width = 11)
