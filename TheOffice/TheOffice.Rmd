...
![The Office](https://image.tmdb.org/t/p/original/A7Pxldr8Y4wYBuIPzqrBnjX5Yrj.jpg)
...
To merge the datasets on episode, we have to clean the ratings file field by removing punctuation, digits, the words "part" and "parts", and make all text lower case. Even after cleaning, three episode titles have to be manually imputed with a case_when statement to succefully join every episode rating with the text of the episode.
