...
residences <- tribble(
  ...
  "Muscatine", "IA", -91.04485, 41.42045, 3, "HON Chairs",
  "Racine", "WI", -87.791916, 42.72062, 3, "Case Corporation<br>Magnum Engineering",
...
These two layers draw richtext labels and curved arrows in sequence.
...
anim_save(filename = here::here("docs","assets","introduction_animation.gif"),
          animation = animation)
```
```{r}
knitr::include_graphics(here::here("docs","assets","introduction_animation.gif"), error = FALSE)
```
