...
train_df %>%
  ...
  labs(x = NULL,
       ...
       title = "Rain tomrrow depends upon the compass direction",
       subtitle = "<span style = 'color:#F8766D'>3pm </span>, <span style = 'color:#00BA38'> 9am</span>, and <span style = 'color:#619CFF'> Overall</span>",
       color = "Time") +
  theme(plot.subtitle = ggtext::element_textbox_simple(),
