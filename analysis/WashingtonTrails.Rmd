...
A video going through this data can be found on [YouTube](https://bit.ly/TidyX_Ep35). Their original scraping code can be found on [GitHub](https://github.com/thebioengineer/TidyX/blob/master/TidyTuesday_Explained/035-Rectangles/Washington-hikes.R). The Washington Trails Assocation website includes this leaflet-style map visual:

<iframe src="https://www.wta.org/go-outside/map" loading="lazy" style="width: 100%; height: 600px; border: 0px none;"></iframe>
...
hike_data %>% 
  ...
  select(-description, -gain, -highpoint, -latitude, -longitude,
         -hike_page, -subregion, -length_total) %>%
