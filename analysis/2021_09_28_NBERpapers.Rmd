...
First, though, let's explore the data with some visuals. Julia Silge's approach to text modeling often goes down a path of exploring the log odds uniqueness of words within the document categories. Let's try her approach, [found here](https://juliasilge.com/blog/nber-papers/). And Emil Hvitfeldt's `prismatic` package offers a nice method of building contrasting text on the bars.
...
```{r patchworked_kk_network_plots}
p80 <- ggraph(net80,
              layout = "kk") +
...
```{r large_confusion_matrix}
#| fig.width: 12
#| fig.asp: 1
#| fig.align: "center"
#| out.width: "300%"
#| fig.alt: >
#|   A confusion matrix illustrating the counts of predictions
#|   versus the truth for the training set used in 
#|   creating the model
