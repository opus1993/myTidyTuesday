...
beer_counts %>%
  ...
  arrange(desc(total)) %>% knitr::kable(caption = "Top 10 Beers")
```
...
by_year_state %>% 
  ...
  labs(title = "Beer awards proportion by year for all states",
       subtitle = "The West coast is strong. Colorado and Virginia are growing most quickly.",
       fill = "", y = "", x = "",
       caption = "Data Source: Great American Beer Festival") +
...
state_words %>% 
  ...
  scale_color_steps2(low = hrbrthemes::ipsum_pal()(9)[[4]],
                     mid = hrbrthemes::ipsum_pal()(9)[[3]],
                     high = hrbrthemes::ipsum_pal()(9)[[8]]) +
  facet_geo(~ state, grid = "us_state_grid2") +
  labs(title = "Beer award winner category distinctive word usage across each state by weighted log odds",
       subtitle = "Who would have guessed Kolch in Kentucky and Kellerbier in North Dakota?",
       fill = "", y = "", x = "",
       caption = "Data Source: Great American Beer Festival") +
