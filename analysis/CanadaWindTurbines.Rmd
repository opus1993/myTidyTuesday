...
p1 <- western_turbines %>% 
  ...
  scale_y_continuous(labels = scales::comma_format(), position = "right") +
  scale_fill_ipsum() +
  labs(y = "", x = "", fill = "",
...
p2 <- ggplot() +
  ...
  geom_richtext(aes(x = -130, y = 58.5,
                    label = "The wind turbines built since 1995 as part of<br>larger wind farm projects in <span style='color:#8fd175'>British Columbia</span>,<br> <span style='color:#d18975'>Alberta</span>, <span style='color:#3f2d54'>Saskatchewan</span> and <span style='color:#75b8d1'>Manitoba</span>."), fill = "white", hjust = 0, label.color = NA, size = 5, color = "#464950", family = "Roboto Condensed") +
  labs(x = "", y = "") +
