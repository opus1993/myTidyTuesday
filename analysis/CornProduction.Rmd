...
#    scale_colour_manual(values = c("black", "orange", "red")) +
  ...
  annotate("text",
           ...
           y = 12.7,
           label = "Consumption",
           color = paletteer_d("ggsci::lanonc_lancet", 1)) +
  annotate("text",
           x = 2013,
           y = 7.5,
           label = "RFS1",
           color = paletteer_d("ggsci::lanonc_lancet", 2)) +
  annotate("text",
           x = 2013,
           y = 15,
           label = "RFS2",
           color = paletteer_d("ggsci::lanonc_lancet", 3)) 
...
Comparing acreage in the 6 years before RFS2 to the most recent 6 years, we see that the largest increases have come in ND, SD, NE, and KS. Corn acreage in 2014-2019 was actually lower in IL and IN than in 2001-2006.
...
df_prod %>%
  mutate(year_group = ifelse(year > 2000 & year < 2007,
                             "Pre_RFS",
                             NA)) %>%
  mutate(year_group = ifelse(year > 2013,
                             "After",
                             year_group)) %>%
  ...
  ggplot(aes(y = reorder(state_alpha, -state_rank), 
    ...
    labs(x = "", y = "",
         subtitle = "Millions of Acres", 
         fill = "Period",
         title = "Change in Average Corn Acreage (2001-2006 vs 2014-2019)",
