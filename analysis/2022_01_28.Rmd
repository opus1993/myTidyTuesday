...
Let's build up some examples data visuals to showcase for ourselves here, and the make a machine learning model. I am going to follow Julia Silge's post, [here](https://juliasilge.com/blog/board-games/), as a startign point. First, load up packages:
...
Ratings here are bounded and always positive. This is a pretty sizeable rectangular dataset so let’s use an xgboost model. How is a characteristic like the minimum recommended age for the game related to the rating?
