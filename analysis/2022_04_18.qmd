...
I am going to attempt to work on her challenge with the new Quarto document framework, github pages, and the `workflowr` site management system. First, let's load the open source packages:
