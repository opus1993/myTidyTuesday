...
#animate(p,  width = 900, height = 750, end_pause = 50, renderer = gifski_renderer("docs/figure/TourDeFrance.Rmd/animation-1.gif"))

animate(p,  width = 900, height = 750, end_pause = 50)
