...
ggsave(filename = "docs/assets/airbender-1.pdf", plot = p1, width = 12, height = 8, device = cairo_pdf)
...
pdftools::pdf_convert(pdf = "docs/assets/airbender-2.pdf", format = "png",
                      dpi = 300, filenames = "docs/assets/airbender-2.png")
...
ggsave(filename = "docs/assets/airbender-3.pdf", plot = p3, width = 12, height = 8, device = cairo_pdf)
...
ggsave(filename = "docs/assets/airbender-4.pdf", plot = p4, width = 12, height = 8, device = cairo_pdf)
...
ggsave(filename = "docs/assets/airbender-5.pdf", plot = p5, width = 12, height = 8, device = cairo_pdf)
