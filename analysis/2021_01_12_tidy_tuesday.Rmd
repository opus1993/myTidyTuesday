...
art %>%
  ...
  labs(title = "The Tate Collection pieces in time are bimodally distributed")
```
...
```{r echo=FALSE}
tweet_embed('https://twitter.com/alexpghayes/status/1349150540610076673')
```

----
# A machine learning model 

Exploring art media over time in the #TidyTuesday Tate collection dataset
...
- Next, we stem words to a similar base word. In this case, I am going to leave stemming out, as the medium works are mostly technical materials.
