...
David Blodgett has a growing set of tools coming together for manipulation of hydrographic data over at the `nhdplusTools` R package that accesses the US National Hydrography Dataset. In place of #TidyTuesday this week, I thought I'd explore the functions available and datasets through the vignettes that he provides at the [package website](https://usgs-r.github.io/nhdplusTools/index.html).
